<h2 align="left">class Attributes(Gilles):<br>	@staticmethod<br>	def contact() -> tuple:<br>	    discord  = ""<br>	    telegram = "t.me/xtekky"<br>	    proton   = "xtekky@protonmail.com"<br>	    <br>	    return discord, telegram, proton<br>	<br>	@staticmethod<br>	def life() -> tuple:<br>		langs         = ['French', 'German', 'Spanish', 'English']<br>		nationalities = self.langs.remove('French', 'English').append('Korean')<br>		age           = 17<br>		<br>		return langs, nationalities, age<br>	<br>	@staticmethod<br>	def coding() -> tuple:<br>		langs = {<br>			'expert':   ['python'],<br>			'intermediate': ['go', 'js'],<br>			'learning': ['c', 'c++', 'c#', 'asm', 'java']<br>		}<br>		specialities  = ['web/app reverse engineering', 'fullstack']<br>		environnement = ['vscode']<br>		<br>		return langs, specialities, environnement</h2>
...
<div align="center">
  <img src="https://profile-counter.glitch.me/gilles20393/count.svg?"  />
</div>
